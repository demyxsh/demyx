...
demyx_help() {
    ...
    case "${1:-$DEMYX_ARG_2}" in
        ...
        config)
            ...
            echo "                   --php                              Switch PHP/LSPHP version. (Usage: --php=<8.3|8.4|83|84>)"
            echo "                   --php-max-requests                 Update php-fpm max requests per child process. (Usage: --php-max-requests=500)"
            echo "                   --pm                               Configure PHP-FPM process manager mode. (Usage: --pm=<ondemand|dynamic|static>)"
        ...
        run)
            ...
            echo "                --php                     Set PHP version. Default: 8.4. (Usage: --php=<8.3|8.4|83|84>)"
