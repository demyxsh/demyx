...
demyx_env() {
    ...
    if [[ -f "$DEMYX_ENV"/.env ]]; then
        ...
        [[ "${DEMYX_APP_OLS_LSPHP:-}" = 8.1 ]] && DEMYX_APP_OLS_LSPHP=8.2
        [[ "${DEMYX_APP_PHP:-}" = 8.1 ]] && DEMYX_APP_PHP=8.2
    else
    ...
    echo "# DEMYX $DEMYX_VERSION
        ...
        DEMYX_APP_OLS_LSPHP=${DEMYX_APP_OLS_LSPHP:-8.2}
        ...
        DEMYX_APP_PHP=${DEMYX_APP_PHP:-8.2}
