...
demyx_stack_env() {
    ...
    [[ -z "$DEMYX_STACK_TRUSTED_IPS" ]] && DEMYX_STACK_TRUSTED_IPS="$DEMYX_TRUSTED_IPS"
    ...
    echo "# AUTO GENERATED
        ...
        DEMYX_STACK_OUROBOROS_IGNORE=\"demyx_socket $DEMYX_STACK_OUROBOROS_IGNORE\"
        ...
        DEMYX_STACK_TRUSTED_IPS=$DEMYX_STACK_TRUSTED_IPS" | sed 's|        ||g' > "$DEMYX_STACK"/.env
}
