...
function demyx_stack_env() {
    ...
    [[ -n "$DEMYX_INSTALL_DOMAIN" ]] && DEMYX_STACK_DOMAIN="$DEMYX_INSTALL_DOMAIN"
    [[ -n "$DEMYX_INSTALL_EMAIL" ]] && DEMYX_STACK_ACME_EMAIL="$DEMYX_INSTALL_EMAIL"
    [[ -n "$DEMYX_INSTALL_PASS" ]] && DEMYX_STACK_AUTH="$DEMYX_STACK_AUTH"
