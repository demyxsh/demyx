...
demyx_env() {
    ...
    echo "# DEMYX $DEMYX_VERSION
        ...
        DEMYX_APP_DB_CONTAINER=${DEMYX_APP_DB_CONTAINER:-${DEMYX_APP_COMPOSE_PROJECT}-db_${DEMYX_APP_ID}-1}
        ...
        DEMYX_APP_NX_CONTAINER=${DEMYX_APP_NX_CONTAINER:-${DEMYX_APP_COMPOSE_PROJECT}-nx_${DEMYX_APP_ID}-1}
